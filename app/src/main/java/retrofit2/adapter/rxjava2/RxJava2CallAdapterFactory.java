...
public final class RxJava2CallAdapterFactory extends CallAdapter.Factory {
  ...
  public static RxJava2CallAdapterFactory createWithScheduler(@android.support.annotation.Nullable Scheduler scheduler) {
  ...
  @Override public @Nullable CallAdapter<?, ?> get(
          @NonNull Type returnType, Annotation[] annotations, Retrofit retrofit) {
